...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md bg-zinc-900/50 backdrop-blur-xl p-10 rounded-[2.5rem] border border-zinc-800 shadow-2xl z-10">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button disabled={loading} className="w-full bg-blue-600 py-4 rounded-xl font-black text-[10px] uppercase hover:bg-blue-500 disabled:opacity-50 flex justify-center items-center gap-2">
        ...
        <p className="text-center mt-8 text-zinc-500 text-[10px] font-black uppercase">
          New operative? <Link href="/signup" className="text-blue-500 hover:underline ml-1">Initialize Shield</Link>
        </p>
      </motion.div>
    </div>
  );
